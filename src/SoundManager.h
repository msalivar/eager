...
const std::string backgroundMusicFilename = "assets/sounds/tankIdle.wav";
...
class SoundMgr : public Manager , public Ogre::FrameListener {
private:
...
public:
	...
	void syncListenerToCamera();
			void attachSelectedNodeToSoundIndex(Entity* ent, unsigned int index);
			...
			///bool playSelectionSound(Entity et);
	...
	//bool registerCreate(FastEcslent::EntityType et, std::string filename);
			//bool registerSelection(Entity et, std::string filename);
